...
const RoadMap = () => {
  return (
    <div id="road-map" className="xmmlg:px-[200px] flex h-auto w-full max-w-[1920px] flex-col items-center px-[29px] py-[50px] md:px-[50px] lg:px-[100px] xl:py-[80px] 2xl:px-[150px] 2xl:py-[100px]">
