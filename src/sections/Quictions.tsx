...
const Quictions = () => {
  return (
    <div id="questions" className="flex h-auto w-full max-w-[1920px] flex-col gap-[50px]">
      ...
      <div className="xmmlg:px-[200px] relative hidden w-full flex-col gap-[30px] md:flex md:px-[50px] lg:px-[100px] 2xl:px-[150px]">
        ...
        <div id="road-map" className="absolute top-1/8 left-6/11 -translate-x-1/2 lg:top-1/8">
